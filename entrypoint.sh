...
if [ -f "/.do_deploy_jasperserver" ]; then
    ...
    echo "Executing ./js-ant create-js-db"
    #echo 'y' | ./js-ant create-js-db || true #create database and skip it if database already exists
    #./js-ant create-js-db || true
    #echo "Executing ./js-ant init-js-db-ce"
    #echo 'y' | ./js-ant init-js-db-ce 
    echo 'y' | ./js-ant import-minimal-ce 
    echo "Executing ./js-ant deploy-webapp-ce"
    echo 'y' | ./js-ant deploy-webapp-ce
    #echo 'y' | ./js-install-ce.sh || true
